...
import cn.bike.platform.report.export.ReportExportModels.DownloadFile;
import cn.bike.platform.report.export.ReportExportModels.ExportJob;
import cn.bike.platform.report.export.ReportExportModels.ExportJobView;
...
public class ReportExportService {
    ...
    public ExportJobView create(ExportRequest request, PlatformPrincipal principal) {
        ...
        LocalDate fromDate;
        LocalDate toDate;
        cn.bike.platform.report.revenue.RevenueReportModels.RevenueGranularity granularity;
        String outputName;
        if (request.reportType() == ReportType.REVENUE) {
            ...
            toDate = fromDate;
            granularity = cn.bike.platform.report.revenue.RevenueReportModels.RevenueGranularity.DAY;
