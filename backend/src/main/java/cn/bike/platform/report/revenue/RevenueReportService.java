...
import cn.bike.platform.report.revenue.RevenueReportModels.RevenuePeriod;
import cn.bike.platform.report.revenue.RevenueReportModels.RevenueReport;
import cn.bike.platform.report.revenue.RevenueReportModels.RevenueSummary;
import cn.bike.platform.report.revenue.RevenueReportModels.RevenueValues;
...
public class RevenueReportService {
     ...
     * 校验收入报表与异步导出共用的查询条件.
     *
     * @param cityCode 6 位行政区代码
     * @param fromDate 查询开始日期, 闭区间
     * @param toDate 查询结束日期, 闭区间
     * @param granularity 统计粒度
     * @throws IllegalArgumentException 参数为空、格式错误或查询范围超过 366 天时抛出
     */
